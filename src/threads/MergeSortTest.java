...
public class MergeSortTest extends Tester implements Runnable {
    private boolean ascending;

    private Timer timer;

    public MergeSortTest(Element[] small_integer, Element[] medium_integer, Element[] big_integer,
    ...
    public void test(Element[] vector) {
        ...
        System.out.println("(" + vector[0].getKey().getClass().getSimpleName() + ") MergeSort with " + vector.length + " elements in " + this.timer.getElapsedTime() + "ms.");
    }
}
