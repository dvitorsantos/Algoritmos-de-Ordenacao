                ...
                case 1:
                    if (formato == 1) {
                      ...
                      if(ordenar==1){
                        ...
                        vectorDouble = sortDouble.MergeSort(vectorDouble, 0, vectorDouble.length-1);
                      }
                      else if(ordenar==4){
                        vectorDouble = sortDouble.HeapSort(vectorDouble);
                      }       
                      else {
                        ...
                        if(ordenar==1){
                          ...
                          vectorInteger = sortInteger.MergeSort(vectorInteger, 0, vectorInteger.length-1);
                        }
                        else if(ordenar==4) {
                        	vectorInteger = sortInteger.HeapSort(vectorInteger);
                        }
                        else {
                        	System.out.println("Informe Um Valor Válido!");
                        }
                        ...
                        if(ordenar==4){
                          vectorString = sortString.HeapSort(vectorString);
                        }
                        if(ordenar==3){
                          vectorString = sortString.MergeSort(vectorString, 0, vectorString.length-1);
                        }
